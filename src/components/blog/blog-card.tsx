...
export const BlogCard = ({
  ...
  return (
    <li ref={cardRef} className="blog-card h-full">
      <Link
        className={`group flex h-full flex-col overflow-hidden rounded-2xl border border-sys-light-outline transition-all duration-[400ms] hover:bg-[#6750A414]`}
        href={'#'}
      >
