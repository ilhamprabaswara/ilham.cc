...
export default function About() {
  return (
    <Layout>
      <div className="grid mb-[50px] md:mb-[100px] md:items-center md:gap-20">
        <div className="max-w-[744px]">
          ...
          <div className="social max-w-[192px]">
            ...
            <Link
              ...
              className="group flex gap-[10px] items-center hover:text-blue-600 mt-[15px] pt-[15px] border-t-[1px] transition"
            >
              <svg
                className="group-hover:fill-blue-600 transition"
                width="24"
